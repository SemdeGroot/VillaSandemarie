...
const nl: Dict = {
  ...
  footer: {
    ...
    intro: "Een familievilla op Curaçao, gemaakt voor samen zijn. Cas Grandi, vlakbij Jan Thiel, met privézwembad en directe lijn met de familie.",
    rights: "",
    gallery: "Foto's",
  },
  about: {
  ...
  content: {
    amenities: {
      ...
      location: "Cas Grandi, vlakbij Jan Thiel",
    ...
    galleryCaptions: {
      ...
      "master-bedroom-r4": "Slaapkamer 3",
...
const de: Dict = {
  ...
  content: {
    ...
    galleryCaptions: {
      ...
      "master-bedroom-r4": "Schlafzimmer 3",
...
const es: Dict = {
  ...
  content: {
    ...
    galleryCaptions: {
      ...
      "master-bedroom-r4": "Habitación 3",
